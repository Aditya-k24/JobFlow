...
const ACCESS_TOKEN_KEY = "glanceai_access_token";
const TOKEN_EXPIRY_KEY = "glanceai_token_expiry";
const LOGIN_HINT_KEY = "glanceai_login_hint"; // persisted for silent refresh
...
export async function launchImplicitFlow({
  ...
  console.log("[Glance AI] redirect_uri:", JSON.stringify(redirectUri));
  console.log("[Glance AI] client_id:", GOOGLE_CLIENT_ID);
